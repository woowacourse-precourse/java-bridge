...
public class Values {
    ...
    public enum Message {
        ...
        ERROR_SIZE("잘못된 길이를 입력했습니다. 길이는 3 이상 20 이하의 숫자여야 합니다. 공백도 허용되지 않습니다."),
        ERROR_MOVE("잘못된 칸을 선택했습니다. (위: U, 아래: D) 둘 중 하나를 선택해야 합니다. 공백도 허용되지 않습니다."),
        ERROR_RETRY("잘못된 값을 입력했습니다. 게임을 다시 시도할지 여부를 입력해주세요.\n(재시도: R, 종료: Q) 둘 중 하나를 선택해야 합니다. 공백도 허용되지 않습니다."),
        ERROR_RE_INPUT("\n다시 입력해주세요.");
        private String message;
