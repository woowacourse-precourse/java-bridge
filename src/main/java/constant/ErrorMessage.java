...
/**
 * 에러 메시지 형식 : [ERROR] 다리 길이는 3부터 20 사이의 숫자여야 합니다.
 */
public class ErrorMessage {
    ...
    public static final String ASK_INPUT_VALUE = "%s 입력값이 필요합니다.";
    public static final String ASK_INPUT_NUMBER = "%s 숫자를 입력하셔야 합니다.";
