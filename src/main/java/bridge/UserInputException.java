...
public class UserInputException extends Exception {
    ...
    public static void numberCheck(String userInput) throws IllegalArgumentException {
    ...
    public static void commandCheck(String userInput, String commandType) throws IllegalArgumentException {
