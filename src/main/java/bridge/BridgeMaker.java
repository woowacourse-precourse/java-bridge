...
import bridge.domain.BridgeComponent;
...
public class BridgeMaker {
    ...
    public List<String> makeBridge(int size) {
        ...
        for(int i=0; i<size; i++){
            ...
            bridge.add(convertBridgeNumber(bridgeNumber));
        }
        return bridge;
    }
    public String convertBridgeNumber(int bridgeNumber) {
        if (bridgeNumber == BridgeComponent.DOWN.getComponentNumber())
        ...
        return BridgeComponent.NOTHING.getComponentLetter();
    }
}
