...
public class Text {
    ...
    public static final String MOVE_TO_WHERE = "이동할 칸을 선택해주세요. (위: U, 아래: D)";
    ...
    public static final String END_MESSAGE = "최종 게임 결과";
    public static final String RESULT_MESSAge = "게임 성공 여부 : ";
    public static final String TOTAL_ATTEMPT_MESSAGE = "총 시도한 횟수 : " ;
}