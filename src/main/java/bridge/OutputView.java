...
public class OutputView {
     ...
     */
    public void printMap(List<String> currentUpState,List<String> currentDownState) {
     ...
     * 출력을 위해 필요한 메서드의 인자(parameter)는 자유롭게 추가하거나 변경할 수 있다.
     */
    public void printSuccessResult(List<String> currentUpState,List<String> currentDownState) {
        System.out.println("최종 게임 결과");
        printMap(currentUpState,currentDownState);
        System.out.println("게임 성공 여부: 성공");
    }
    public void printFailResult(List<String> currentUpState,List<String> currentDownState) {
        System.out.println("최종 게임 결과");
        printMap(currentUpState,currentDownState);
