...
public class OutputView {
    ...
    public void printManyValueList(int num, List<String> bridge, int isAnswer) {
        if(isAnswer == 0) {
            printIsFaileValueList(bridge, num);
            return;
        }
        if(isAnswer == 1) {
            printIsSuccesValueList(bridge, num);
            return;
        }
    }

    public void printIsSuccesValueList(List<String> bridge, int num) {
    ...
    public void printIsFaileValueList(List<String> bridge, int num) {
        List<String> upString = new ArrayList<>();
        List<String> downString = new ArrayList<>();
