...
public class OutputView {
    ...
    public static void printResult(List<String> bridgePattern, List<String>currentInputHistory, String successOrNot, int retryCount) {
        OutputMessage.GAME_RESULT_MESSAGE.println();
        printMap(bridgePattern, currentInputHistory);
        OutputMessage.SUCCESS_FAIL_MESSAGE.printSuccessOrNot(successOrNot);
        OutputMessage.RETRY_COUNT_MESSAGE.printRetryCount(retryCount);
