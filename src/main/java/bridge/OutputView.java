...
public class OutputView {
     ...
     * 출력을 위해 필요한 메서드의 인자(parameter)는 자유롭게 추가하거나 변경할 수 있다.
     */
    public void printResult(int length, List<String> answer, List<String> submission) {
        System.out.println("최종 게임 결과");
        printUpSideBridge(length - 1, answer, submission);
        printDownSideBridge(length - 1, answer, submission);
    }
