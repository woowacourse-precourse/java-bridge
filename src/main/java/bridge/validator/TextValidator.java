...
public class TextValidator {
    private static final String MOVE_WAY_ERROR_MESSAGE = "[ERROR] 이동 방향은 U또는 D만 입력 가능합니다.";
    private static final String RETRY_ERROR_MESSAGE = "[ERROR] 재시작 여부는 R과 Q로만 입력할 수 있습니다.";
