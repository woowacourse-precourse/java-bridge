...
public class Valid {
	...
	public static String validateMovingInput(String movingInput) {
		if (!isUorD(movingInput)
			|| !validateMovingInputLength(movingInput)
			|| !isUpperCaseOfMovingInput(movingInput)) {
	...
	private static boolean validateMovingInputLength(String movingInput) {
	...
	private static boolean isUpperCaseOfMovingInput(String movingInput) {
