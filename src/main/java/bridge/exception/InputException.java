...
public class InputException {
    ...
    private static final String NOT_SPACE_FORMAT = "[ERROR] 칸은 대문자 U 또는 D로 나타내야 합니다.";
    private static final String NOT_ONLY_ONE_LENGTH = "[ERROR] 칸은 한 글자로 입력해야 합니다.";
    ...
    public static void printNotSpaceFormatException() {
