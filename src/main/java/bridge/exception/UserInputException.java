...
public class UserInputException {
    ...
    private static final String ERROR_INVALID_COMMAND_SIZE = "[ERROR] 한 글자만 입력해 주세요.";
    private static final String ERROR_INVALID_MOVING_COMMAND_CHARACTER = "[ERROR] \'U\' 또는 \'D\'만 입력해 주세요.";
    private static final String ERROR_INVALID_RETRY_COMMAND_CHARACTER = "[ERROR] \'R\' 또는 \'Q\'만 입력해 주세요.";
