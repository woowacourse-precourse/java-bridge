...
public class InputValidate {
  ...
  public void isDigitBridgeSize(String strSize) {
  ...
  public void isInRangeBridgeSize(int bridgeSize) {
  ...
  public void isValidLength(String inputValue) {
    if (inputValue.length() != 1) {
      throw new IllegalArgumentException("[ERROR] 한 글자만 입력해 주세요.");
    }
  }

  public void isValidMoving(String inputMovingValue) {
  ...
  public void isValidCommand(String inputCommandValue) {
