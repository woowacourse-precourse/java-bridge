...
public class OutputView {
    ...
    public static void printResultMap(BridgeMapMaker bridgeMapMaker, RoundResult roundResult) {
        System.out.println(Constants.GAME_END_MESSAGE);
        printMap(bridgeMapMaker, roundResult);
    }
     ...
     * 출력을 위해 필요한 메서드의 인자(parameter)는 자유롭게 추가하거나 변경할 수 있다.
     */
    public static void printResult(String result, int trial) {
        System.out.printf(Constants.GAME_RESULT_MESSAGE, result);
        System.out.printf(Constants.TOTAL_TRIAL_MESSAGE, trial);
    }
}
