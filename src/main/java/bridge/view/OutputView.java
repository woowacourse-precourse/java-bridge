...
public class OutputView {
    ...
    public void printResult(String gameResult, int gameTryCount, String lastMapResult) {
        printGameFinalBridgeResult(); // 최종 게임 결과
        System.out.println(lastMapResult); // 게임 정보 출력
        printGameSuccessOrFailure(gameResult); // 게임 성공 여부
        printGameTotalTryCount(gameTryCount); // 총 시도한 횟수
    }
