...
public class OutputView {
     ...
     * 출력을 위해 필요한 메서드의 인자(parameter)는 자유롭게 추가하거나 변경할 수 있다.
     */
    public void printResult(List<String> upperCell, List<String> lowerCell, Integer retryCnt) {
        System.out.println(OutputMessage.FINAL_GAME_RESULT_MESSAGE);
        printMap(upperCell, lowerCell);
        System.out.println(OutputMessage.GAME_STATUS_MESSAGE.getMessage() + "실패");
