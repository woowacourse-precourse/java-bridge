...
public class OutputView {
	...
	private final String SPLIT_DIRECTION_UP = "U";
	private final String SPLIT_DIRECTION_DOWN = "D";
	...
	public void printMap(BridgeMap bridgeMap) {
		System.out.println(bridgeMap.getSplitMap(SPLIT_DIRECTION_UP));
		System.out.println(bridgeMap.getSplitMap(SPLIT_DIRECTION_DOWN));
		System.out.println();
	}
