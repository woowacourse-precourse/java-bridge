...
public interface Exception {
    ...
    public final String MOVING_STRING_EXCEPTION_MESSAGE = "[ERROR] 이동 시 위 칸은 대문자 U, 아래 칸은 대문자 D여야 합니다.";
    public final String GAME_COMMAND_STRING_EXCEPTION_MESSAGE = "[ERROR] 재시작은 대문자 R, 종료는 대문자 Q여야 합니다.";
