...
public class Constants {
    ...
    public static final String WRONG_RANGE_MESSAGE =
            EXCEPTION_PREFIX + String.format("다리 길이의 범위는 최소 %d ~ %d 사이 입니다.",
                    BridgeSize.START_INCLUSIVE, BridgeSize.END_INCLUSIVE);

    // Bridge Exception Message
    public static final String WRONG_BRIDGE_VALUE_MESSAGE =
        EXCEPTION_PREFIX + "다리의 구성요소가 잘못 생성되었습니다.";

    // Moving Command Message
    public static final String WRONG_MOVING_COMMAND_MESSAGE =
        EXCEPTION_PREFIX + "이동 커멘드를 잘못 입력하였습니다.";
