...
public class BridgeGame {
     ...
     */
    private void move(String answer, String readMoving) {
    ...
    private void moveUpperBridge(String answer, String readMoving) {
        if (answer.equals("D")) {
            upperBridge.add("   ");
            return;
        }
    ...
    private void moveUnderBridge(String answer, String readMoving) {
        if (answer.equals("U")) {
            underBridge.add("   ");
            return;
        }
