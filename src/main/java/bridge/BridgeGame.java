...
public class BridgeGame {
     ...
     */
    public void move(CurrentBridgeState currentBridge, String moveCommand, boolean isPossibleMove) {

        List<String> upBridgeResult = currentBridge.getUpBridgeState();
        List<String> downBridgeResult = currentBridge.getDownBridgeState();
