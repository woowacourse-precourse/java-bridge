...
public class BridgeGame {
    ...
    public String checkRetryCommand(String input) {
        return validatorProcessor.validateRetryInput(input);
    }

    public String checkMoveCommand(String input) {
        return validatorProcessor.validateCommandInput(input);
    }
