...
public enum ExceptionType {
    ...
    IS_NOT_ONE_ALPHABET("입력한 값이 한 개의 알파벳이 아닙니다."),
    IS_NOT_UPPER_ALPHABET("입력한 값이 대문자가 아닙니다."),
    IS_NOT_MOVING_ALPHABET("입력한 값이 U와 D가 아닌 다른 값입니다."),
    IS_NOT_GAME_COMMAND_ALPHABET("입력한 값이 R과 Q가 아닌 다른 값입니다.");
