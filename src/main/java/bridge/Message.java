...
public enum Message {
    ...
    ERROR_INT("다리 길이는 숫자여야 합니다."),
    ERROR_LENGTH("다리 길이는 3부터 20 사이의 숫자여야 합니다."),
    ERROR_MOVE("입력은 U 혹은 D여야 합니다. 다시 입력해 주세요. (위: U, 아래: D)"),
    ERROR_RETRY("입력은 R 혹은 Q여야 합니다. 다시 입력해 주세요. (재시도: R, 종료: Q)");
