...
public class IOMessage {
    ...
    public static final String UP_OR_DOWN = "이동할 칸을 선택해주세요. (위: U, 아래: D)";
    public static final String RETRY_OR_EXIT = "게임을 다시 시도할지 여부를 입력해주세요. (재시도: R, 종료: Q)";
    public static final String GAME_RESULT = "최종 게임 결과";
    public static final String GAME_SUCCESS = "게임 성공 여부: ";
    public static final String TYR_COUNT = "총 시도한 횟수: ";
}
