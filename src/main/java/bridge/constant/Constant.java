...
public class Constant {
    ...
    public static final int BRIDGE_INITIAL_POSITION = -1;
    public static final int INITIAL_INDEX = 0;
    public static final int LOWER_BRIDGE = 0;
    public static final int UPPER_BRIDGE = 1;
    public static final int INDEX_ZEROING_NUMBER = 1;
