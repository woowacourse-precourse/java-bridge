...
public class GameForm {
    ...
    public static final String UP_CODE = "U";
    public static final String DOWN_CODE = "D";

    public static final String RESTART_CODE = "R";
    public static final String QUIT_CODE = "Q";
