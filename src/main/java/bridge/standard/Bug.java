...
public class Bug {
    ...
    public static final String MOVING_PATTERN = "[" + GameForm.UP_VALUE + GameForm.DOWN_VALUE + "]";
    public static final String GAME_COMMAND_PATTERN = "[" + GameForm.RESTART_VALUE + GameForm.QUIT_VALUE + "]";
