...
public class ConstantMessage {
    ...
    public static final String REQUEST_BRIDGE_LENGTH_MESSAGE = "다리의 길이를 입력해주세요.";
    public static final String REQUEST_MOVE_DIRECTION_MESSAGE = "이동할 칸을 선택해주세요. (위: U, 아래: D)";
    public static final String REQUEST_GAME_RETRY_ANSWER_MESSAGE = "게임을 다시 시도할지 여부를 입력해주세요. (재시도: R, 종료: Q)";
    ...
    public static final String INVALID_RETRY_COMMAND_MESSAGE = "[ERROR] 사용자가 입력할 수 있는 명령은 R 또는 Q 입니다.";
}
