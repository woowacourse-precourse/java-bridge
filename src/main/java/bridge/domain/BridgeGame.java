...
public class BridgeGame {
     ...
     */
    public GameState move(User user, Bridge bridge, String position) {
     ...
     */
    public GameState retry(User user, String command) {
        if (command.equals(GameState.RETRY.getState())) {
            user.initialize();
    ...
    public Bridge makeBridgeGame(int bridgeSize) {
