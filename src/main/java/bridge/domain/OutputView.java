...
public class OutputView {
     ...
     */
    public void printMap(MatchResult matchResult, List<String> userInput, boolean match) {
        matchResult.matchProcess(userInput, match);
        matchResult.printUpAndDownSides();
    }
