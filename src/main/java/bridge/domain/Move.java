...
public enum Move {
    ...
    public static String convertDirection(int number) {
        return Arrays.stream(Move.values())
                ...
                .findAny()
                .orElseThrow(() -> new IllegalArgumentException(GameException.SYSTEM_ERROR_BRIDGE_GENERATE.name()))
                .direction;
    }
    ...
    public static Move from(String direction) {
        return Arrays.stream(Move.values())
                ...
                .findAny()
                .orElseThrow(() -> new IllegalArgumentException(GameException.INVALID_DIRECTION.name()));
    }
}
