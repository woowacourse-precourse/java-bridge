...
public enum ErrorCode {
    ...
    MOVING_NOT_U_D("이동할 때 위 칸은 대문자 " + BridgeConstants.BRIDGE_GAME_MOVING_UP + ", 아래 칸은 대문자 "
            + BridgeConstants.BRIDGE_GAME_MOVING_DOWN + " 만 가능합니다."),
    GAME_COMMAND_NOT_R_Q(
            "재시도 여부 값은 재시도는 대문자 " + BridgeConstants.BRIDGE_GAME_COMMAND_RETRY + ", 종료는 대문자 "
                    + BridgeConstants.BRIDGE_GAME_COMMAND_QUIT + " 만 가능합니다.");
