...
import bridge.domain.PlayerBoard;
...
public class OutputView {
     ...
     * 출력을 위해 필요한 메서드의 인자(parameter)는 자유롭게 추가하거나 변경할 수 있다.
     */
    public void printResult(boolean isComplete,int attempts, PlayerBoard board) {
        printMessage(Commands.FINAL_RESULT_MESSAGE.message());
        String upsideBridge = board.getBridgeStatus(UP);
        String downsideBridge = board.getBridgeStatus(DOWN);
