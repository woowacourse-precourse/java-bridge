...
public class BridgeGameValidator {
    ...
    public void validateUserInputForMove(String userInputForMove) {
        if (userInputForMove.equals(BridgeGameInfo.LOWER_MOVE) || userInputForMove.equals(BridgeGameInfo.UPPER_MOVE))
            return;
    ...
    public void validateGameCommand(String gameCommand) {
        if (gameCommand.equals(BridgeGameInfo.GAME_RESTART_COMMAND) || gameCommand.equals(BridgeGameInfo.GAME_QUIT_COMMAND))
            return;
