...
public class BridgeGameTest {
    ...
    void init_초기화_테스트() {
        ...
        assertThat(bridgeGame.type).isEqualTo(BridgeGame.GameStatus.진행중);
    }
    ...
    void move_인자가_실제값과_일치할때_동작_테스트() {
        ...
        assertThat(bridgeGame.type).isEqualTo(BridgeGame.GameStatus.성공);
    }
    ...
    void move_인자가_실제값과_일치하지_않을때_동작_테스트() {
        ...
        assertThat(bridgeGame.type).isEqualTo(BridgeGame.GameStatus.실패);
    }
    ...
    void renderUpperRow와_renderLowerRow의_반환값이_실제와_같은지_테스트() {
        ...
        List<String> userInput = new ArrayList<>(List.of("U", "U", "D", "D", "U"));
        assertThat(bridgeGame.renderUpperRow(bridge, userInput)).isEqualTo("[ O | O |   |   | O ]\n");
        assertThat(bridgeGame.renderLowerRow(bridge, userInput)).isEqualTo("[   |   | O | O |   ]\n");
    }
