...
public class DirectionTest {
    ...
    public void getDirectionFromStringTest() {
        assertThat(Direction.getDirection("UP")).isEqualTo(Direction.UP);
        assertThat(Direction.getDirection("DOWN")).isEqualTo(Direction.DOWN);
    }
    ...
    public void getDirectionFromNumberTest() {
        assertThat(Direction.getDirection(0)).isEqualTo(Direction.UP);
        assertThat(Direction.getDirection(1)).isEqualTo(Direction.DOWN);
    }
    ...
    public void getDirectionListFromStringListTest() {
        assertThat(Direction.getDirections(List.of("UP", "DOWN")))
