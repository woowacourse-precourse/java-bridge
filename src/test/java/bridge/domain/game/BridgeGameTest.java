...
class BridgeGameTest {
    ...
    class DescribeIntGeneratorConstructorTest {
        ...
        class ContextWithInvalidSizeAndGenerator {
            ...
            void itThrowsException(int size) {
                ...
                assertThatThrownBy(() -> new BridgeGame(size, validGenerator))
    ...
    class DescribeMoveMethodTest extends CommonStubBridgeGeneratorField {
        ...
        class ContextWhenNotEndBridgeWithReadMovingDto {
            ...
            void itReturnsBoolean(String validInput, GameStatus expectedStatus) {
                ReadMovingDto readMovingDto = new ReadMovingDto(validInput);

                MoveDto move = bridgeGame.move(readMovingDto);

                assertThat(move.getNextGameStatus()).isSameAs(expectedStatus);
            }
        }

        @Nested
        @DisplayName("만약 마지막 다리에서 유효한 ReadMovingDto가 주어지면")
        class ContextWhenEndBridgeWithReadMovingDto {

            @Test
            @DisplayName("입력한 다리로 플레이어가 이동할 수 있는지를 계산해 MoveDto로 반환한다")
            void itReturnsMoveDto() {
        ...
        class ContextWithInvalidReadMovingDto {
    ...
    class DescribeRetryMethodTest extends CommonStubBridgeGeneratorField {
        ...
        class ContextWithInvalidReadGameCommandDto {
    ...
    class DescribeExitMethodTest extends CommonStubBridgeGeneratorField {
