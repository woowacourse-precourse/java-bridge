...
public class BridgeTest {
    public static final Bridge UPPER_BRIDGE = new Bridge(() -> 1, 3);
    public static final Bridge LOWER_BRIDGE = new Bridge(() -> 0, 3);
    
    @Test
    @DisplayName("다리 길이와 현재 포지션이 같은지 확인")
    void isGameFinished() {
        assertThat(UPPER_BRIDGE.isSameWithBridgeSize(3)).isTrue();
    }
