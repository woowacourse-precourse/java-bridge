...
class RequestTest {
    ...
    @DisplayName("생성자 메소드에 R 혹은 Q를 입력되었을 때 Request 객체가 생성되는지 확인")
    @ParameterizedTest
