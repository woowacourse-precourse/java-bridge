...
class BridgeGameRepositoryTest {
    ...
    @DisplayName("round와 tryCount의 기본값은 1이다.")
    @Test
    void test1() {
    ...
    @DisplayName("retry를 하면 tryCount 값이 1 증가하며 round는 기본값으로 변경된다.")
    @Test
    void test3() {
    ...
    @DisplayName("현재 라운드가 finalRound와 일치하면 true를 반환한다.")
    @Test
    void test4() {
        bridgeGameRepository.goToNextRound();
        bridgeGameRepository.goToNextRound();
    ...
    @DisplayName("현재 라운드가 finalRound와 일치하지않으면 false를 반환한다.")
    @Test
    void test5() {
