...
class BridgeGameTest {
    ...
    void 다리를_건널_수_있으면_true() {
        assertThat(bridgeGame.move(0, "U")).isTrue();
    }

    @DisplayName("저장된 다리를 건널 수 없다면 false")
    @Test
    void 다리를_건널_수_없으면_false() {
        assertThat(bridgeGame.move(0, "D")).isFalse();
    }
    ...
    void 다리를_건널_수_있으면_UP_저장() {
        ...
        assertThat(bridgeGame.getPlayResult().getPlayResult().get(0))
    ...
    void 재시작_코드가_입력되면_실패_결과_삭제() {
        ...
        assertThat(bridgeGame.getPlayResult().getPlayResult().size())
                .isEqualTo(0);
    }
    ...
    void 재시작_코드가_입력되면_시도_횟수_증가() {
        ...
        assertThat(bridgeGame.getPlayResult().getTryCount())
                .isEqualTo(2);
    }
}