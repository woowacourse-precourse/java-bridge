...
class InputViewTest {
    ...
    void readBridgeSizeNumberFormatExceptionTest(String bridgeSize) {
    ...
    void readBridgeSizeRangeExceptionTest(String bridgeSize) {
        final byte[] buf = String.join("\n", bridgeSize).getBytes();
        System.setIn(new ByteArrayInputStream(buf));
    ...
    void readMovingExceptionTest(String moving) {
        final byte[] buf = String.join("\n", moving).getBytes();
        System.setIn(new ByteArrayInputStream(buf));
    ...
    void readGameCommandExceptionTest(String gameCommand) {
