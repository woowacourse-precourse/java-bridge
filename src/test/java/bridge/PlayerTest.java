...
public class PlayerTest {
    ...
    void executeIsPlayerMoveToTrue() {
        ...
        bridge.setBridge(List.of("U", "D", "U"));
    ...
    void executeIsPlayerMoveToFalse() {
        Bridge bridge = new Bridge();
        bridge.setBridge(List.of("U", "D", "D"));
        player.updateMoveInfo("U");
        player.updateMoveInfo("D");
        player.updateMoveInfo("U");
    ...
    void executeIsClearGameToFalse(String bridge1, String bridge2, String bridge3,
        ...
        Bridge bridge = new Bridge();
        bridge.setBridge(List.of(bridge1, bridge2, bridge3));
    ...
    void executeIsClearGameToFalse2(String bridge1, String bridge2, String bridge3,
