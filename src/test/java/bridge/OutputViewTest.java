...
class OutputViewTest {
    ...
    void 예제_출력_테스트1() {
        ...
        final List<String> bridgeState = Arrays.asList("U", "D", "D");
        final List<String> moveState = Arrays.asList("U", "D", "D");
    ...
    void 예제_출력_테스트2() {
        ...
        final List<String> bridgeState = Arrays.asList("U", "D", "D", "U", "U", "U", "D", "D");
        final List<String> moveState = Arrays.asList("U", "D", "D", "U", "U", "U", "D", "U");
        outputView.printMap(bridgeState, moveState);
        assertThat(outputStream.toString()).isEqualTo(output);
    }
    ...
    void 비정상_상태_테스트() {
        final List<String> bridgeState = Arrays.asList("U", "D", "D");
        final List<String> moveState = Arrays.asList("D", "D", "D");
