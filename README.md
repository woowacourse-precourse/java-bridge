...
- [x]  BridgeRandomNumberGenerator에서 반드시 숫자 생성 기능을 구현하도록 하는 인터페이스
### 4. BridgeRandomNumberGenerator
- [x] 0 혹은 1중 무작위 숫자를 생성하는 기능
### 5. InputView
- [x] 사용자로부터 다리 길이를 입력받는 기능
- [x] 사용자로부터 이동할 칸을 입력받는 기능
- [x] 사용자의 게임 재시작 여부를 입력받는 기능
### 6. OutputView
- [x] 게임 진행 상황을 보여주는 기능
- [x] 게임의 최종 결과를 보여주는 기능
### 7. BrideMapGenerator
- [x] bridgeMap을 생성하는 기능
### 8. GameControlloer
- [x] bridgeGame을 생성하고 실행하는 기능
