...
|15| 사용자가 잘못된 값을 입력할 경우 IllegalArgumentException를 발생시키는가? <br> - 다리 길이 입력에서 3이하 숫자를 입력하였을 때 "[ERROR]"가 출력되고 다시 입력을 받는가?|☑️|
|16| 사용자가 잘못된 값을 입력할 경우 IllegalArgumentException를 발생시키는가? <br> - 다리 길이 입력에서 40이상 숫자를 입력하였을 때 "[ERROR]"가 출력되고 다시 입력을 받는가?|☑️|
|17| 사용자가 잘못된 값을 입력할 경우 IllegalArgumentException를 발생시키는가? <br> - 다리 길이 입력에서 아무 것도 입력하지 않았을 때 "[ERROR]"가 출력되고 다시 입력을 받는가?|☑️|
|18| 사용자가 잘못된 값을 입력할 경우 NumberFormatException 발생시키는가? <br> - 다리 길이 입력에서 문자를 입력했 을 때 "[ERROR]"가 출력되고 다시 입력을 받는가?|☑️|
|19| 사용자가 잘못된 값을 입력할 경우 IllegalArgumentException를 발생시키는가? <br> - 사용자가 이동할 칸 입력에서 U, D가 아닌 다른 문자를 입력 하였을 때"[ERROR]"가 출력되고 다시 입력을 받는가?|☑️|
|20| 사용자가 잘못된 값을 입력할 경우 IllegalArgumentException를 발생시키는가? <br> - 사용자가 이동할 칸 입력에서 아무 것도 입력하지 않았을 때"[ERROR]"가 출력되고 다시 입력을 받는가?|☑️|
|21| 사용자가 잘못된 값을 입력할 경우 IllegalArgumentException를 발생시키는가? <br> - 재시도 여부 입력에서 R, Q가 아닌 다른 문자를 입력하였을 때 "[ERROR]"가 출력되고 다시 입력을 받는가?|☑️|
