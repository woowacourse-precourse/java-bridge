...
### OutputView
- [x] 현재까지 이동한 다리의 상태를 정해진 형식에 맞게 출력하는 기능 -> printMap
- [x] 게임 최종 결과를 정해진 형식에 맞게 출력하는 기능 -> printResult
- [x] ERROR를 출력하는 기능 -> printException
...
### Bridge Game
- [x] 요구사항에 맞게 Bridge maker에게 다리를 만들도록 일을 넘김 -> createBridge
- [x] 사용자가 칸을 이동하게 하는 기능 -> move
- [x] 사용자가 이동한 칸이 옳바른 방향인지 판단하는 기능 -> judge
- [x] 게임결과가 성공했는지 확인하는 기능 -> isSuccess
- [x] 재시도 해야하는 상태를 확인하는 기능 -> isGameOver
- [x] 게임 초기화 하는 기능 -> retry
- [x] 게임 상태를 반환하는 기능 -> getStatus
- [x] 최종 결과 객체를 만드는 기능 -> getResultOfGame
